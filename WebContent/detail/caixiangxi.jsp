		...
		<div id="menu1">
			...
			<div class="menu3">
				<div class="menu3_left">
					<img src="${pageContext.request.contextPath}/ImageController?imageName=${param.imageName}"
						style="width:270px; height:290px;" />
				</div>
				<div class="menu3_right">
					<p>菜名:${param.foodName}</p>
					<p>价格:&nbsp;&nbsp;&yen;&nbsp;${param.price}</p>
					<p>简介:${param.synopsis}</p>
				</div>
			</div>
			<div class="menu4">
				
				<a href="${pageContext.request.contextPath}/FoodCartServlet?fid=${param.fid}&foodName=${param.foodName}&price=${param.price}" style="background:url(style/images/img/order_left_corner_bg.png);">放入餐车</a>
